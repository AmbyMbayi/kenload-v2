...
export default [
	...
	},
	{
		...
		component: () => import('../views/pages/vehicles/special-release')
	},
	{
		...
		component: () => import('../views/pages/vehicles/vehicle-details')
	},
	{
		path: '/add-vehicle',
		name: 'add-vehicle',
		...
		component: () => import('../views/pages/vehicles/add-vehicle')
	}
];
